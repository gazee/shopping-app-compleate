...
const removeitemHandler=(id)=>{
  ...
  // <p>wello</p>
    <div className='container'>
       <div className='close_cart_item' onClick={()=>{removeitemHandler(data.id)}}>
           <span className="iconify"  data-icon="ci:close-big" data-width="30" data-height="30"></span>
        </div>
        <div className='image_cart_item'>
